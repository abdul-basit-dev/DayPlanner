...
public class editActivity extends AppCompatActivity {
    ...
    String intentID,intentTitle,intentContent,intentType,intentTime,intentDate,intentDay;

    String date, finalTime, finalDate,message,title;
    ...
    TextView tv_daily_time, tv_oneTime_time, tv_oneTime_day,tv_week_day,tv_week_time,edit_WT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting up toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.edit_work_toolbar_id);
        ...
        intentID = String.valueOf(getIntent().getIntExtra("wid",0));
        intentTitle = getIntent().getStringExtra("wtitle");
        intentContent = getIntent().getStringExtra("wcontent");
        intentType = getIntent().getStringExtra("wtype");
        intentDate = getIntent().getStringExtra("wdate");
        intentTime = getIntent().getStringExtra("wtime");
        intentDay = getIntent().getStringExtra("wday");
...
//        datePicker_week = findViewById(R.id.datePicker_week);
        ...
        //Toast.makeText(this, "id:"+intentID+"   "+intentType, Toast.LENGTH_SHORT).show();
        editText_wrokName.setText(intentTitle);
        editText_Content.setText(intentContent);
        tv_daily_time.setText(intentTime);
        tv_oneTime_day.setText(intentDate);
        tv_oneTime_time.setText(intentTime);
        tv_week_time.setText(intentTime);
        tv_week_day.setText(intentDay);
        edit_WT.setText(intentType);
        ...
        mAdapterWorkType = new ArrayAdapter<>(editActivity.this, R.layout.spinnerlayout, mArrayWorkType);
       // spinnerWorkType.setEnabled(false);
        ...
        spinnerWorkType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (intentType.equalsIgnoreCase("Daily")) {
...
//                        layout_week_datePicker.setVisibility(View.GONE);
                ...
                } else if (intentType.equalsIgnoreCase("One Time")) {
                ...
                }else if (intentType.equalsIgnoreCase("Weekly")){
                    Toast.makeText(editActivity.this, ""+selectedItem, Toast.LENGTH_SHORT).show();
...
//Click listener On Daily Time View.(TEXTVIEW)
        tv_daily_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animation bottomUp = AnimationUtils.loadAnimation(editActivity.this, R.anim.bottom_up);
...
////////////////// Start WEEK WORK ////////////////////////
       ...
       // tv_week_time.setText(intentTime); //setting current time to TextView-oneTime Work
       ...
       // date = Integer.toString(datePicker_oneTime.getYear()) + Integer.toString(mMonth) + Integer.toString(datePicker_oneTime.getDayOfMonth());
        ...
        tv_week_day.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Animation rightTOleft = AnimationUtils.loadAnimation(editActivity.this, R.anim.left_to_right);
...
//        //set type,milliseconds,intent
        ...
        imageViewDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(editActivity.this,MyAlarmServices.class);
                intent.putExtra("notificationID",notificationId);
                intent.putExtra("title",title);
                intent.putExtra("message",message);
                intent.setAction("SNOOZE");
                final PendingIntent pendingIntent = PendingIntent.getBroadcast(editActivity.this,1,intent,PendingIntent.FLAG_UPDATE_CURRENT);

                alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);

                //Creating Time
                String[] partA = dailySelectedTime.split(":");
                int aHour = timePicker_oneTIme.getCurrentHour();
                int bHour = timePicker_oneTIme.getCurrentMinute();
                ...
                alarmManager.setRepeating(AlarmManager.RTC_WAKEUP,alarmStartTime, TimeUnit.DAYS.toMillis(1),pendingIntent);
               // Toast.makeText(addNewPlanActivity.this, ""+TimeUnit.DAYS.toMillis(1), Toast.LENGTH_SHORT).show();
                updateDB();
    ...
    public void updateDB() {
        // Toast.makeText(getApplicationContext(), "this:"+selectedItem, Toast.LENGTH_SHORT).show();
     ...
     //   sqLiteDatabase.insert("dailyWorkTwo", null, contentValues);
        String where = "id=?";
        sqLiteDatabase.update("dailyWorkTwo", contentValues, where, new String[]{intentID});
